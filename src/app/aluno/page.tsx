...
export default async function StudentPage() {
  ...
  const selectingPlan = Boolean(subscription && !subscription.hasCustomPrice && !subscription.manualMonthlyBilling);
