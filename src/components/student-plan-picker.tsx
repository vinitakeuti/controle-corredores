...
type Plan = { id: string; period: "MONTHLY" | "QUARTERLY" | "SEMIANNUAL" | "ANNUAL"; priceCents: number; allowedMethods: ("PIX" | "BOLETO" | "CARD")[]; automaticPixEnabled: boolean; service: { name: string } };
